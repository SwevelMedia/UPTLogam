                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif($os->status <= 6) <span class="badge-custom bg-info me-2"></span>Design
                                        @elseif($os->status == 7)
                                ...
                                <td>
                                    ...
                                    <button class="text-center btn btn-success btn-sm px-3 accept-btn"
                                        data-orderid="{{ $os->id }}" data-status="1" data-bs-toggle="modal"
            ...
            <div class="modal-body">
                <form role="form" method="POST" action="{{ url('ppic/order') }}" enctype="multipart/form-data">
                    ...
                    <datalist id="perusahaan-list">
                        ...
                        <option value="{{ $riwayat->client->name }}" data-phone="{{ $riwayat->client->phone }}"
                    ...
                    <div class="mb-3">
                        <input type="text" id="phone" name="phone" class="form-control" placeholder="Nomer Perusahaan"
                    ...
                    <div class="mb-3">
                        <input type="file" name="gambar[]" class="form-control" placeholder="Gambar" aria-label="Gambar"
                            aria-describedby="gambar-addon" multiple>
                    </div>
